 ...
 *  Execution: java-introcs RecursiveSquares n
 *
 *  Purpose: This program takes an integer command-line argument n and plots a
 *  recursive square pattern of order n.
 **************************************************************************** */
...
public class RecursiveSquares {
    ...
    public static void draw(int n, double x, double y, double length) {
        ...
        draw(n - 1, x + length / 2, y + length / 2, length / 2); // upper right corner
        draw(n - 1, x - length / 2, y + length / 2, length / 2); //  Upper left Corner
        drawSquare(x, y, length);
        draw(n - 1, x + length / 2, y - length / 2, length / 2); // lower right corner
        draw(n - 1, x - length / 2, y - length / 2, length / 2); // lower left corner
